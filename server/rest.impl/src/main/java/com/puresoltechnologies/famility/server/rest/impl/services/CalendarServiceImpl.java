...
public class CalendarServiceImpl implements CalendarService {
	...
	long id = calendarManager
		.insertEvent(com.puresoltechnologies.famility.server.rest.impl.services.RestConverter.convert(event));
	...
	boolean updated = calendarManager.updateSeries(id,
		com.puresoltechnologies.famility.server.rest.impl.services.RestConverter.convert(series));
	if (!updated) {
	...
	CalendarSeries series = com.puresoltechnologies.famility.server.rest.impl.services.RestConverter
