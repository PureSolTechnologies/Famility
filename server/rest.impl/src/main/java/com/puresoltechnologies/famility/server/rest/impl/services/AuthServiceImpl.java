...
import com.puresoltechnologies.famility.server.impl.accounts.User;
import com.puresoltechnologies.famility.server.impl.passwords.PasswordStoreImpl;
import com.puresoltechnologies.famility.server.rest.api.auth.AuthService;
import com.puresoltechnologies.famility.server.rest.impl.auth.AuthElement;
import com.puresoltechnologies.famility.server.rest.impl.auth.PermitAll;
import com.puresoltechnologies.famility.server.rest.impl.auth.SupportedRoles;
