...
public class Event implements Comparable<Event> {
    ...
    public Event(long id, String type, String title, String description, Collection<Contact> participants,
    ...
    public Event(String type, String title, String description, Collection<Contact> participants, Reminder reminder,
