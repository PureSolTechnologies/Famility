...
public class CalendarEntryTest {
	...
	CalendarEntry appointment = new CalendarEntry("birthday", "Birthday", "description", participants, true,
	...
	CalendarEntry deserialized = JsonSerializer.fromString(serialized, CalendarEntry.class);
