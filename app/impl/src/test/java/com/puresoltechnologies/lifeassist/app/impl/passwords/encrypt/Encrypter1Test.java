...
public class Encrypter1Test {
	...
	assertFalse(encrypted.isEmpty());
	System.out.println("Encrypted password: " + encrypted);
	assertFalse(Encrypter1.check(password, encrypted.substring(0, encrypted.length() - 2)));
    }
	...
	assertFalse(encrypted.isEmpty());
	System.out.println("Encrypted password: " + encrypted);
	assertFalse(Encrypter1.check(password, encrypted.substring(0, encrypted.length() - 1)));
    }
