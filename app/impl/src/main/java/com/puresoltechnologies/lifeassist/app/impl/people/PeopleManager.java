...
public class PeopleManager {
	...
	try (ExtendedSQLQueryFactory queryFactory = DatabaseConnector.createQueryFactory()) {
	    SQLQuery<Long> selectEntrySerie = queryFactory.select(QPeople.people.birthdayEntrySerieId)
		    .from(QPeople.people);
	    Long entrySerieId = selectEntrySerie.fetchOne();

	    SQLDeleteClause delete = queryFactory.delete(QPeople.people).where(QPeople.people.id.eq(id));
