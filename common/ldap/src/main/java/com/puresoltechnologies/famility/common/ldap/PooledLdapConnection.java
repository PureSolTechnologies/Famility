 ...
 *
 */
public class PooledLdapConnection implements LdapConnection {

    private final LdapConnectionPool pool;
    private final LdapConnection connection;

    public PooledLdapConnection(LdapConnectionPool pool, LdapConnection connection) {
	super();
	this.pool = pool;
	...
	try {
	    ...
	    throw new IOException("Could not return connection.", e);
	}
    }
